...
m$Sub_metering_3<-as.numeric(levels(m$Sub_metering_3))[m$Sub_metering_3]
...
plot(m$date_time,m$Voltage,xlab="datetime",ylab="Voltage",type="l",lty=1,
)
...
plot(m$date_time,m$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type="l",lty=1,
)
dev.off()